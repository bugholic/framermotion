...
export const CallToAction = () => {
  ...
  const [mouseX, mouseY] = useMousePosition(borderedDiv); 
      ...
      <div className="container">
        ...
        >
          ...
          <div className="relative inset-0">
            ...
            <p className="text-center text-lg md:text-xl text-white/70 px-8 md:px-10 mt-5 tracking-tight max-w-sm mx-auto">
